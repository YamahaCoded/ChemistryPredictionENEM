...
Análise fazendo o uso de regressão linear com o objetivo de prever um valor aproximado da quantidade de questões referentes a específicos conteúdos através de um pequeno conjunto de dados de questões de química das edições do ENEM dos últimos 4 anos.  
